...
export namespace UpdatePage {
  export type Variables = UpdatePageMutationVariables;
  export type Mutation = UpdatePageMutation;
  export type UpdatePage = (NonNullable<UpdatePageMutation['updatePage']>);
}

export namespace CreatePage {
  export type Variables = CreatePageMutationVariables;
  export type Mutation = CreatePageMutation;
  export type CreatePage = (NonNullable<CreatePageMutation['createPage']>);
}

export namespace GetPages {
  export type Variables = GetPagesQueryVariables;
  export type Query = GetPagesQuery;
  export type Pages = (NonNullable<GetPagesQuery['pages']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<GetPagesQuery['pages']>)['items']>)[number]>;
}

export namespace DeletePage {
  export type Variables = DeletePageMutationVariables;
  export type Mutation = DeletePageMutation;
}

export namespace GetPage {
  export type Variables = GetPageQueryVariables;
  export type Query = GetPageQuery;
